...
#[cfg(feature = "io-util")]
#[cfg_attr(docsrs, doc(cfg(feature = "io-util")))]
#[doc = r###"Read bytes from a source.
...
pub trait AsyncReadExt: AsyncRead {
    #[doc = r###"Create a new `AsyncRead` instance that chains this stream with
`next`.
...
```"###]
    ...
    #[doc = r###"Pull some bytes from this source into the specified buffer,
...
```"###]
    ...
    #[doc = r###"Read the exact number of bytes required to fill `buf`.
...
[`ErrorKind::UnexpectedEof`]: std::io::ErrorKind::UnexpectedEof"###]
    ...
    read_impl! {
        #[doc=r###"Reads an unsigned 8 bit integer from the underlying reader.
...
```"###]
        ...
        #[doc=r###"Reads a signed 8 bit integer from the underlying reader.
...
```"###]
        ...
        #[doc=r###"Reads an unsigned 16-bit integer in big-endian order from the
underlying reader.
...
```"###]
        ...
        #[doc=r###"Reads a signed 16-bit integer in big-endian order from the
underlying reader.
...
```"###]
        ...
        #[doc=r###"Reads an unsigned 32-bit integer in big-endian order from the
underlying reader.
...
```"###]
        ...
        #[doc=r###"Reads a signed 32-bit integer in big-endian order from the
underlying reader.
...
```"###]
        ...
        #[doc=r###"Reads an unsigned 64-bit integer in big-endian order from the
underlying reader.
...
```"###]
        ...
        #[doc=r###"Reads an signed 64-bit integer in big-endian order from the
underlying reader.
...
```"###]
        ...
        #[doc=r###"Reads an unsigned 128-bit integer in big-endian order from the
underlying reader.
...
```"###]
        ...
        #[doc=r###"Reads an signed 128-bit integer in big-endian order from the
underlying reader.
...
```"###]
    ...
    #[doc = r###"Read all bytes until EOF in this source, placing them into `buf`.
...
[`tokio::fs::read`]: crate::fs::read::read"###]
    ...
    #[doc = r###"Read all bytes until EOF in this source, appending them to `buf`.
...
[`crate::fs::read_to_string`]: crate::fs::read_to_string::read_to_string"###]
    ...
    #[doc = r###"Creates an adaptor which reads at most `limit` bytes from it.
