...
pub trait AsyncWriteExt: AsyncWrite {
    #[doc = r###"Write a buffer into this writer, returning how many bytes were
written.
...
```"###]
    ...
    #[doc = r###"Write a buffer into this writer, advancing the buffer's internal
cursor.
...
```"###]
    ...
    #[doc = r###"Attempts to write an entire buffer into this writer.
...
[`write`]: AsyncWriteExt::write"###]
    ...
    write_impl! {
        #[doc=r###"Writes an unsigned 8-bit integer to the underlying writer.
...
```"###]
        ...
        #[doc=r###"Writes an unsigned 16-bit integer in big-endian order to the
underlying writer.
...
```"###]
        ...
        #[doc=r###"Writes a signed 16-bit integer in big-endian order to the
underlying writer.
...
```"###]
        ...
        #[doc=r###"Writes an unsigned 32-bit integer in big-endian order to the
underlying writer.
...
```"###]
        ...
        #[doc=r###"Writes a signed 32-bit integer in big-endian order to the
underlying writer.
...
```"###]
        ...
        #[doc=r###"Writes an unsigned 64-bit integer in big-endian order to the
underlying writer.
...
```"###]
        ...
        #[doc=r###"Writes an signed 64-bit integer in big-endian order to the
underlying writer.
...
```"###]
        ...
        #[doc=r###"Writes an unsigned 128-bit integer in big-endian order to the
underlying writer.
...
```"###]
        ...
        #[doc=r###"Writes an signed 128-bit integer in big-endian order to the
underlying writer.
...
```"###]
    ...
    #[doc = r###"Flush this output stream, ensuring that all intermediately buffered
...
```"###]
    ...
    #[doc = r###"Shuts down the output stream, ensuring that the value can be dropped
cleanly.
